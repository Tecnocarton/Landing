...
## Corpus Check
- 74 files · ~99,854 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 356 nodes · 606 edges · 32 communities (15 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.87)
...
5. `Refactor Progresivo Landing Plan` - 12 edges
6. `buildMetadata()` - 11 edges
7. `SharedFooter()` - 10 edges
...
Cohesion: 0.15
Nodes (13): carouselImages, Hero(), StatCard, Nav(), LINKS, SiteHeader(), cn(), FlipWords (+5 more)
...
Cohesion: 0.10
Nodes (22): POST(), resend, sanitizeInput(), sanitizePhone(), dmSans, plusJakarta, metadata, RootLayout() (+14 more)
...
Cohesion: 0.08
Nodes (34): metadata, getProcessIcon(), getSustainabilityIcon(), Proceso(), scaleIn, staggerContainer, CaseStudies(), ClientsCarousel() (+26 more)
...
Cohesion: 0.09
Nodes (23): metadata, generateMetadata(), Page(), metadata, generateMetadata(), Page(), staticRoutes, JsonLd() (+15 more)

### Community 11 - "postulacion/route.js"
Cohesion: 0.20
Nodes (8): aboutPageJsonLd, metadata, qualityIcons, sustainabilityIcons, trustStats, verticalPillars, qualityCertifications, sustainability
...
## Knowledge Gaps
- **134 isolated node(s):** `resend`, `COUNTER_FILE`, `resend`, `metadata`, `metadata` (+129 more)
...
- **What is the exact relationship between `Refactor Progresivo Landing Plan` and `Form Step 0 validation fix (disabled button)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `siteConfig` connect `API Layout & Analytics` to `Landing Page Core Component`, `Box Finder Tool`, `Careers Page & Ads Analytics`, `layout.js`, `postulacion/route.js`, `Quote Submission API`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `theme` connect `Careers Page & Ads Analytics` to `Landing Page Core Component`, `layout.js`, `postulacion/route.js`, `Box Finder Tool`?**
